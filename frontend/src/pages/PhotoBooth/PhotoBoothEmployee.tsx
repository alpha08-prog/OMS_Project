...
export default function PhotoBoothEmployee() {
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="rounded-2xl border-amber-200">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl text-amber-900">Search Archive — Coming soon</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-4">
                <p className="text-muted-foreground">
                  Archive search depends on photo uploads, which are currently being upgraded.
  ...
  // Original page kept below for reference once uploads are restored.
