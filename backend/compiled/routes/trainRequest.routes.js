...
const trainRequest_controller_1 = require("../controllers-catalyst/trainRequest.controller");
...
const rejectValidation = [(0, express_validator_1.body)('reason').optional().trim()];
