...
class GrievanceCreatePage extends StatefulWidget {
  ...
  const GrievanceCreatePage({super.key, this.onCreated});
...
class _GrievanceCreatePageState extends State<GrievanceCreatePage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (monetaryVal.isNotEmpty) {
        body["monetaryValue"] = monetaryVal;
      }

      final letterTemplate = letterTemplateController.text.trim();
      if (letterTemplate.isNotEmpty) {
        body["letterTemplate"] = letterTemplate;
      }
      ...
      if (res.statusCode == 201 || res.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Grievance created successfully")),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Public Grievance"),
            ...
            _buildCard(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) =>
                      (v == null || v.trim().isEmpty) ? "Constituency is required" : null,
                ),
              ],
            ),
            ...
            _buildCard(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: "Monetary Value (optional)",
                    border: OutlineInputBorder(),
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: actionRequiredOptions.map((t) {
                    return DropdownMenuItem(
                      value: t['value'],
                      child: Text(t['label']!),
                    );
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: "Letter Template (optional)",
                    border: OutlineInputBorder(),
